package fr.syzonia.core.tablist;
...
public class TeamsTagManager {
	...
	public TeamsTagManager(String name, String prefix, String suffix, Scoreboard current) throws Exception {
		this.prefix = prefix;
		this.suffix = suffix;
	...
	public TeamsTagManager(String name, String prefix, String suffix) throws Exception {
	...
	public static void setNameTag(Player player, String name, String prefix, String suffix){
		try{
			TeamsTagManager tagplayer = new TeamsTagManager(name, prefix, suffix);
